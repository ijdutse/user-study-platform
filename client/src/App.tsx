...
function AssessmentApp() {
  ...
  const handleConsent = (email: string) => {
    // We store the email temporarily or send it with demographics if needed.
    // For now, we'll just move to the next step.
    // In a real app, we might want to create the participant record here.
    // But to keep it simple and match existing flow, we'll send it with demographics.
    // We'll attach it to the window or state for the next step.
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      {step === 5 && (
        <DebriefPage
          ...
          onBack={() => {
            setStep(4);
            // Ensure we are at the last video
